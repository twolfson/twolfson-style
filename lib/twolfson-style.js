...
// TODO: Add support for `--process-globs` to get Windows support
...
exports.precheck = function (pathArr, options, done) {
  ...
  var jshintChild = spawn('jshint.cmd', args, {
    // [stdin, stdout, stderr]
...
exports.lint = function (pathArr, options, done) {
  // Start a jshint script
  var jshintChild = spawn('jshint.cmd', pathArr, {
    // [stdin, stdout, stderr]
    stdio: [null, options.stdout, options.stderr]
  });
  ...
  jshintChild.on('exit', function handleJshintExit (code, signal) {
    ...
    // Otherwise
      ...
      // Run jscs
      var jscsChild = spawn('jscs.cmd', pathArr, {
        // [stdin, stdout, stderr]
        stdio: [null, options.stdout, options.stderr]
      });
